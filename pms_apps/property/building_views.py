...
def _building_to_camel_case(row: dict) -> dict:
    return {
        ...
        'numberOfUnits': row.get('number_of_units'),
        ...
        'powerSupply': row.get('power_supply'),
        ...
        'allowedIndustryTypesOther': row.get('allowed_industry_types_other'),
    ...
    def create_extract(self, params: BuildingCreateRequest):
        with transaction.atomic():
            ...
            building_id = building.create(
                ...
                allowed_industry_types_other=params.allowed_industry_types_other,
