...
from pms_apps.helper_apis.utils.nationality import NationalityUtils
...
class NationalityView:
    ...
    @Common(response_handler=NationalityResponseGetAllSerilizers).exception_handler
    def get_all(self,params : GetAll):
        with transaction.atomic():

            pages = Paginator(Nationality.get_all(
            ...
            lead_utils = NationalityUtils(columns_required=[column for column in params.values.split(',') if column])
