...
from pms_apps.owner.dataclasses.request.get import OwnerGetRequest
from pms_apps.common.swagger import SwaggerPage
from drf_spectacular.types import OpenApiTypes
from drf_spectacular.utils import OpenApiParameter


class OwnerGetRequestSerializer(GetSerializer):
    owner_id = serializers.IntegerField()

    def create(self, validated_data) -> OwnerGetRequest:
        return OwnerGetRequest(**validated_data)
