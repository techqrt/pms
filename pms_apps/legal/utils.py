...
class LegalUtils:
    def __init__(self, entity: str, columns_required: list = []) -> None:
        ...
        manager_map = {
            ...
            'total_cases_handled': 'totalCasesHandled',
        ...
        employee_map = {
            ...
            'case_specialization': 'caseSpecialization',
    ...
    def reverse_mapper(fields: list[str]) -> dict[str, str]:
        combined_map = {}
        combined_map.update(LegalUtils('manager').mapped_columns_name)
        combined_map.update(LegalUtils('employee').mapped_columns_name)
