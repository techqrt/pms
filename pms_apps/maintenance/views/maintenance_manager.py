...
class MaintenanceManagerView:
    def __init__(self):
        self.manager_create = "Maintenance manager added successfully"
        self.manager_update = "Maintenance manager updated successfully"
        self.manager_delete = "Maintenance manager deleted successfully"
    ...
    def delete_manager_extract(self, params):
        with transaction.atomic():
            ...
            if manager_data is None:
                raise ValueError(self.data_no_match)
            MaintenanceManager.remove(manager_id=params.manager_id)
