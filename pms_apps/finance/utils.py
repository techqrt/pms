...
class FinanceUtils:
    def __init__(self, entity: str, columns_required: list = []) -> None:
        ...
        manager_map = {
            ...
            'total_budget_managed': 'totalBudgetManaged',
            'reports_submmited': 'reportsSubmitted',
            'team_size': 'teamSize',
        ...
        employee_map = {
            ...
            'total_amount_handled': 'totalAmountHandled',
    ...
    def reverse_mapper(fields: list[str]) -> dict[str, str]:
        combined_map = {}
        combined_map.update(FinanceUtils('manager').mapped_columns_name)
        combined_map.update(FinanceUtils('employee').mapped_columns_name)
