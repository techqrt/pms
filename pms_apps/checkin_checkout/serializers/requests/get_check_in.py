...
class CheckInGetSerializer(GetSerializer):
    check_in_id = serializers.IntegerField()

    def create(self, validated_data) -> CheckInGetRequest:
        return CheckInGetRequest(check_in_id=validated_data['check_in_id'])
    ...
    def get_parameters(default_parameters: list = None):
        ...
        default_parameters.append(OpenApiParameter(
            name='check_in_id', description='ID of the Check-In',
