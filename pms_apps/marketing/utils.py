...
class MarketingUtils:
    def __init__(self, entity: str, columns_required: list = []) -> None:
        ...
        self.entity = entity  # 'manager' or 'employee'
    ...
    def reverse_mapper(fields: list[str]) -> dict[str, str]:
        combined_map = {}
        combined_map.update(MarketingUtils('manager').mapped_columns_name)
        combined_map.update(MarketingUtils('employee').mapped_columns_name)
