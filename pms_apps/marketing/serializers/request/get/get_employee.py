...
from pms_apps.marketing.dataclasses.request.get.get_employee import MarketingEmployeeGetRequest
from pms_apps.common.swagger import SwaggerPage
from drf_spectacular.types import OpenApiTypes
from drf_spectacular.utils import OpenApiParameter


class MarketingEmployeeGetRequestSerializer(GetSerializer):
    employee_id = serializers.IntegerField()

    def create(self, validated_data) -> MarketingEmployeeGetRequest:
        return MarketingEmployeeGetRequest(**validated_data)
