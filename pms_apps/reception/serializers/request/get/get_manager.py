...
from pms_apps.reception.dataclasses.request.get.get_manager import ReceptionManagerGetRequest
from pms_apps.common.swagger import SwaggerPage
from drf_spectacular.types import OpenApiTypes
from drf_spectacular.utils import OpenApiParameter


class ReceptionManagerGetRequestSerializer(GetSerializer):
    manager_id = serializers.IntegerField()

    def create(self, validated_data) -> ReceptionManagerGetRequest:
        return ReceptionManagerGetRequest(**validated_data)
