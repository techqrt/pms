...
from pms_apps.collection.dataclasses.request.get.get_employee import CollectionEmployeeGetRequest
from pms_apps.common.swagger import SwaggerPage
from drf_spectacular.types import OpenApiTypes
from drf_spectacular.utils import OpenApiParameter


class CollectionEmployeeGetRequestSerializer(GetSerializer):
    employee_id = serializers.IntegerField()

    def create(self, validated_data) -> CollectionEmployeeGetRequest:
        return CollectionEmployeeGetRequest(**validated_data)
