...
class CollectionUtils:
    def __init__(self, entity: str, columns_required: list = []) -> None:
        ...
        manager_map = {
            ...
            'overdue_accounts_managed': 'overdueAccountsManaged',
            'team_size': 'teamSize',
        ...
        employee_map = {
            ...
            'overdue_accounts_handled': 'overdueAccountsHandled',
    ...
    def reverse_mapper(fields: list[str]) -> dict[str, str]:
        combined_map = {}
        combined_map.update(CollectionUtils('manager').mapped_columns_name)
        combined_map.update(CollectionUtils('employee').mapped_columns_name)
